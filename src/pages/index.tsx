  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the revolution in job application with JobFit - your ultimate tool for effortless resume creation, customization, and optimization. Streamline your job search journey and increase your chances of landing your dream job."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxqb2IlMjBzZWFyY2h8ZW58MHx8fHwxNjk1MTE3MDY2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the revolution in job application with JobFit - your ultimate tool for effortless resume creation, customization, and optimization. Streamline your job search journey and increase your chances of landing your dream job.`}
            </Text>
            <Box
