...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'job-seeker', 'recruiter', 'job-fit-administrator', 'hr-manager'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Resumes', path: '/resumes', entity: 'resume', service: AccessServiceEnum.PROJECT, icon: FiFileText },
    { name: 'Templates', path: '/templates', entity: 'template', service: AccessServiceEnum.PROJECT, icon: FiLayout },
