...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'job.create': {
    roles: ['job-seeker', 'job-fit-administrator'],
    key: 'job-posted',
    tenantPath: ['organization', 'job'],
    userPath: [],
  },
  'resume.update': {
    roles: ['recruiter', 'hr-manager', 'job-fit-administrator'],
    key: 'resume-updated',
    tenantPath: ['organization', 'user', 'resume'],
    userPath: [],
  },
  'application.update': {
    roles: ['job-seeker', 'job-fit-administrator'],
    key: 'application-status-changed',
    tenantPath: ['organization', 'job', 'application'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['job-seeker', 'recruiter', 'business-owner', 'job-fit-administrator', 'hr-manager'];
